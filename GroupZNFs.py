...
def main():
    ...
    parser.add_argument("--output_fasta", required=True, help="Output FASTA file with merged sequences")
    ...
    parser.add_argument("--clustering_threshold", type=float, default=4, help="Input threshold for hierarchical clustering of edit distances")
    ...
    # Merge identical sequences and save the merged FASTA
    merge_identical_sequences(args.fasta_file, args.output_fasta)
    ...
    cluster_sequences(edit_distance_df, threshold=args.clustering_threshold)
